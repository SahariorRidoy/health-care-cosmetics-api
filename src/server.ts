...
import factoryOrderRoutes from './modules/production/factoryOrder.routes';
import factoryBatchRoutes from './modules/production/factoryBatch.routes';
...
app.use('/api/v1/factory-batches', factoryBatchRoutes);
